...
public:
    ...
    /**
     * Allocates the image, records the upload and the mip chain, and writes
     * the descriptor.
     *
     * @param buffers supplies the upload space level 0 is staged through.
     * @param commandBuffer an open transfer batch.
     * @param pixels tightly packed level 0, matching format and extent.
     * @param format texel format; uncompressed, since the mip chain is blitted.
